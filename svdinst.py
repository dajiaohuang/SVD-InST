...
#model = torch.load('logs/mural2023-12-23T18-24-48_mural/checkpoints/last.ckpt')
model = model.to(device)
main(prompt = '*', \
     content_dir = '/lustre/home/acct-stu/stu045/Downloads/photo_mural_data/test/e98c174738.jpg', \
