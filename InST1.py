...
if __name__ == "__main__":
	config="configs/stable-diffusion/v1-inference-svdiff.yaml"
	ckpt="models/sd/sd-v1-4.ckpt"
	#ckpt="/lustre/home/acct-stu/stu045/InST/logs/mural2023-12-23T18-24-48_mural/checkpoints/last.ckpt"
	...
	#content_dir = "../Downloads/photo_mural_data/test2"
	content_dir = sys.argv[1]

	for imgfl in os.listdir(content_dir):
		content_img = os.path.join(content_dir, imgfl)
		for i in range(10):
			torch.manual_seed(i)
			seed = torch.randint(0,100,(1,))
			instmain(content_img, seed, model)
